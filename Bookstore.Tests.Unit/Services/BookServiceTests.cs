...
public sealed class BookServiceTests : IDisposable
{
    ...
    public void Dispose()
    {
        if (dbContext is TestDbContext context)
        {
    ...
    public async Task CreateAsync_ShouldCreateBook_WithoutAuthorsAndGenres()
    {
        ...
        var bookInDb = await dbContext.Books.FindAsync(result.Id);
    ...
    public async Task UpdateAsync_ShouldReturnNull_WhenBookDoesNotExist()
    {
        ...
        var result = await bookService.UpdateAsync(999, request);
    ...
    public async Task UpdateAsync_ShouldUpdatePrice_WhenBookExists()
    {
        ...
        var result = await bookService.UpdateAsync(1, request);

        result.Should().NotBeNull();
        result!.Id.Should().Be(1);

        var bookInDb = await dbContext.Books.FindAsync(1);
    ...
    {
        var result = await bookService.DeleteAsync(999);
    ...
    public async Task UpdateAuthorsAsync_ShouldReturnNull_WhenBookDoesNotExist()
    {
        ...
        var result = await bookService.UpdateAuthorsAsync(999, request);
    ...
    public async Task UpdateAuthorsAsync_ShouldReplaceAuthors_WhenBookExists()
    {
        ...
        var result = await bookService.UpdateAuthorsAsync(1, request);
    ...
    public async Task UpdateGenresAsync_ShouldReturnNull_WhenBookDoesNotExist()
    {
        ...
        var result = await bookService.UpdateGenresAsync(999, request);
    ...
    public async Task UpdateGenresAsync_ShouldReplaceGenres_WhenBookExists()
    {
        ...
        var result = await bookService.UpdateGenresAsync(1, request);
